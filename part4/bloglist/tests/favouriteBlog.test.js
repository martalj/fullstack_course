...
describe('favourite blog', () =>{
    ...
    const listWithManyBlogs = [
      ...
      test('when list has several blogs, find the one with most likes', () => {
      ...
      const listWithEqualLikes = [
        ...
        test('when list has more blogs with most likes, return one', () => {
            const result = listHelper.favouriteBlog(listWithEqualLikes)
            assert.deepStrictEqual(result, listWithManyBlogs[0])
          })
